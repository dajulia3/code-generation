...
public class SymbolTable {
    private ArrayList<HashMap<String, SymbolInfo>> scopes = new ArrayList<HashMap<String, SymbolInfo>>();
    private HashMap<String, SymbolInfo> currentScope = new HashMap<String, SymbolInfo>();
    
    public void enterScope() {
        scopes.add(currentScope);
        currentScope = new HashMap<String, SymbolInfo>();
    }
