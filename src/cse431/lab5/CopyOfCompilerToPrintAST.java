...
public class CopyOfCompilerToPrintAST {
    
    /**
     * Modified file only to print the AST (will go into my log file)
     * This class is just to help me write the code generation visitor using my test cases
    ...
    public static void main(String[] args) {
        ...
        CopyOfCompilerToPrintAST compiler = new CopyOfCompilerToPrintAST(args[0]);
        try {
            compiler.run();
        } catch (Exception e) {
    ...
    private CopyOfCompilerToPrintAST(String source) {
        this.source = source;
    }
    ...
    private void processFile(File sourceFile, File parentDir) throws Exception {
        ...
        printAST(cu);
        //generateCode(cu); Don't need the code, just the AST
